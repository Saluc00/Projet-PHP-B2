...
@section('content')
    ...
    <div class="container">
        <div id="messages" style="height: 60vh;"
             class="border rounded bourder-dark p-3 m-3 overflow-auto messageEnDirect">
        ...
        <form action="/envoie/message/{{ $id }}-{{ $id2 }}" method="post" id="monform" class="m-auto">
            {{ csrf_field() }}
